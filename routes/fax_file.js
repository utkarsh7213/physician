            ...
            docx.on('finalize', (written) => {
                ...
                function sendFax() {
                    ...
                    interfax.outbound.deliver({
                        ...
                        .then(fax => {
                            res.send("FAX Sent Successfully to Noblesville Pharmacy : " + process.env.FAX_NUMBER);
                            console.log("FAX Sent Successfully to Pharmacy : " + process.env.FAX_NUMBER);
                            console.log(doc_file);
                        })
                        .catch(error => {
                            console.error("Error sending fax to : " + process.env.FAX_NUMBER);
                            res.json({err_fax : `FAX not sent to Noblesville Pharmacy : ${process.env.FAX_NUMBER}`});
                        });
                }
